namespace Totten.Solution.RagnaComercio.Application.Tests.VendingStores;
using AutoMapper;
...
using Totten.Solution.RagnaComercio.ApplicationService.Features.StoreAgregattion.CommandsHandler;
