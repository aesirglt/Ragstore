namespace Totten.Solution.RagnaComercio.ApplicationService.Notifications.Stores.Handlers;
using MediatR;
using System.Threading;
using System.Threading.Tasks;
using Totten.Solution.RagnaComercio.Domain.Features.HistoricAggregation.Interfaces;
