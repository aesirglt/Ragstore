    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CallbackId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallbacksSchedule_Callbacks_CallbackId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("89300f33-33d7-4878-af08-1f7b694eca3f"), new DateTime(2025, 5, 17, 8, 2, 10, 944, DateTimeKind.Utc).AddTicks(9640), "Latam RO", false, "latamro", "https://ro.gnjoylatam.com/", new DateTime(2025, 5, 17, 8, 2, 10, 944, DateTimeKind.Utc).AddTicks(9642) });

            migrationBuilder.InsertData(
                table: "Agents",
                columns: new[] { "Id", "CreatedAt", "IsActive", "Name", "ServerId", "UpdatedAt" },
                values: new object[] { new Guid("89300f33-33d7-4878-af08-1f7b694eca3f"), new DateTime(2025, 5, 17, 8, 2, 10, 945, DateTimeKind.Utc).AddTicks(4375), true, "openkore", new Guid("89300f33-33d7-4878-af08-1f7b694eca3f"), new DateTime(2025, 5, 17, 8, 2, 10, 945, DateTimeKind.Utc).AddTicks(4375) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallbacksSchedule_CallbackId",
                table: "CallbacksSchedule",
                column: "CallbackId");
        }
